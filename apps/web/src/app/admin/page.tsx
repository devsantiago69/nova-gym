...
export default async function AdminDashboard() {
  ...
  return <section>
    ...
    <div className="mt-6 grid gap-3 sm:grid-cols-3"><Link href="/admin/usuarios" className="card flex items-center gap-3 p-4 transition hover:border-lime-400"><UserCheck className="text-lime-300"/><div><strong>Gestionar accesos</strong><p className="text-xs muted">Editar, suspender o restablecer</p></div></Link><Link href="/admin/planes" className="card flex items-center gap-3 p-4 transition hover:border-violet-400"><WalletCards className="text-violet-300"/><div><strong>Configurar planes</strong><p className="text-xs muted">Precios y límites del SaaS</p></div></Link><Link href="/admin/categorias-retos" className="card flex items-center gap-3 p-4 transition hover:border-orange-400"><Dumbbell className="text-orange-300"/><div><strong>Diseñar retos</strong><p className="text-xs muted">Metas, duración y recompensas</p></div></Link></div>
  </section>;
}
